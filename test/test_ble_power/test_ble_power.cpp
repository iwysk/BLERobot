...
constexpr int delaytime = 3000;
void changeBLEPower(void* pvParameters);
...
void setup(void) 
{
    ...
    motor.attach(16, 17);
    InitBLEServer();
    xTaskCreateUniversal(changeBLEPower, "changePower", 8192, NULL, 0, NULL, APP_CPU_NUM);
}
...
void changeBLEPower(void* pvParameters) {
    log_i("N14");
    BLEDevice::setPower(ESP_PWR_LVL_N14, ESP_BLE_PWR_TYPE_DEFAULT);
    ...
    log_i("N11");
    BLEDevice::setPower(ESP_PWR_LVL_N11, ESP_BLE_PWR_TYPE_DEFAULT);
    vTaskDelay(pdMS_TO_TICKS(delaytime));
    ...
    log_i("N8");
    BLEDevice::setPower(ESP_PWR_LVL_N8, ESP_BLE_PWR_TYPE_DEFAULT);
    vTaskDelay(pdMS_TO_TICKS(delaytime));
    ...
    log_i("N5");
    BLEDevice::setPower(ESP_PWR_LVL_N5, ESP_BLE_PWR_TYPE_DEFAULT);
    vTaskDelay(pdMS_TO_TICKS(delaytime));
    ...
    log_i("N2");
    BLEDevice::setPower(ESP_PWR_LVL_N2, ESP_BLE_PWR_TYPE_DEFAULT);
    vTaskDelay(pdMS_TO_TICKS(delaytime));
    ...
    log_i("P1");
    BLEDevice::setPower(ESP_PWR_LVL_P1, ESP_BLE_PWR_TYPE_DEFAULT);
    vTaskDelay(pdMS_TO_TICKS(delaytime));
    ...
    log_i("P4");
    BLEDevice::setPower(ESP_PWR_LVL_P4, ESP_BLE_PWR_TYPE_DEFAULT);
    vTaskDelay(pdMS_TO_TICKS(delaytime));
